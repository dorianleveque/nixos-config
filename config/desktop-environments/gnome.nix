...

{
  ...
  systemd.tmpfiles.rules = [
    ...
    "d /run/gdm/.cache 0750 gdm gdm -"
    "d /run/gdm/.cache/ibus 0770 gdm gdm -"
    "d /run/gdm/.local 0740 gdm gdm -"
    "d /run/gdm/.local/share 0740 gdm gdm -"
    "d /run/gdm/.local/share/gnome-shell 0740 gdm gdm -"
    "d /run/gdm/.local/share/icc 0740 gdm gdm -"
    "d /run/gdm/.local/state 0740 gdm gdm -"
  ];
}
